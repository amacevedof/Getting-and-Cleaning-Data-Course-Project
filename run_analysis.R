...
names(HAR_new) <- gsub("BodyAccMagmeanFreq","magnitude body acceleration frequency mean", names(HAR_new))
names(HAR_new) <- gsub("BodyAccJerkMagmeanFreq","magnitude body acceleration Jerk frequency mean", names(HAR_new)) 
names(HAR_new) <- gsub("BodyGyroMagmeanFreq","magnitude angular velocity frequency mean", names(HAR_new))
names(HAR_new) <- gsub("BodyGyroJerkMagmeanFreq","magnitude angular velocity Jerk frequency mean", names(HAR_new))
names(HAR_new) <- gsub("meanFreq","frequency mean ", names(HAR_new))
names(HAR_new) <- gsub("MagmeanFreq","magnitude frequency mean ", names(HAR_new))
